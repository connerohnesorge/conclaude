...
<CardGrid>
  <Card title="Getting Started" icon="rocket">
    Follow the [Getting Started guide](guides/getting-started) to configure conclaude for your first project.
  </Card>
  <Card title="CLI Reference" icon="open-book">
    See the [CLI Reference](reference/cli) for all available commands and options.
  </Card>
</CardGrid>
