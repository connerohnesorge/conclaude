---
title: Teammate Idle
description: Configuration options for teammateIdle
---
...
Map of teammate name patterns to command configurations. Keys are glob patterns matching teammate names.
