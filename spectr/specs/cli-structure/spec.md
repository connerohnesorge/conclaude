...
Defines the CLI command structure for conclaude, organizing all hook-handling commands under a parent `Hooks` subcommand to provide a clean, hierarchical interface and prevent top-level command clutter.
